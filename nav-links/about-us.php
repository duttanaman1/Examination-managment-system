...
<body>
  ...
  <header class="header-section header-normal">
    <div class="container">
      <div class="logo">
        <a href="../index.html">
         <img src="img/logo.png" alt="LOGO" height="40em">
        </a>
      </div>
      <div class="nav-menu">
        ...
        <div class="col-lg-6 offset-lg-1">
          <div class="about-text">
            <div class="section-title">
              ...
              <p>
                Our dedicated Ponigym areas and fitness experts can help you
        ...
        <div class="row">
          <div class="col-lg-3 col-sm-6">
            <div class="ci-item">
              ...
              <p>
                Event Calendar and Event Calendar Pro full support out of the
                box.
              </p>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-lg-10">
                <div class="section-title">
                  ...
                  <p>
                    Shape your body and burn fat with strength training. With
                    the right equipment such as free weights or resistance
                    machines.
                  </p>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      ...
                      <button type="submit" name="submit">
                        Submit <i class="ti-angle-double-right"></i>
                      </button>
                    </div>
                  </div>
                </form>
